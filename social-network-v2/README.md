...
- `POST /post/add-to-favorites?post_id={id}` - добавить в избранное
- `DELETE /post/remove-from-favorites?post_id={id}` - убрать из избранного
...
- `GET /user/get_all_users` - список всех пользователей
